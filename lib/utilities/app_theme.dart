...
class AppTheme {
  static ThemeData defaultThemeData = ThemeData(
    ...
    textTheme: const TextTheme(
      displayLarge: TextStyle(fontSize: 24, color: AppColors.black, fontWeight: FontWeight.w700),
      ...
      bodyMedium: TextStyle(color: AppColors.black, fontSize: 18, fontWeight: FontWeight.w700),
    ),
    ...
    dividerColor: AppColors.primaryColor.withValues(alpha: 0.2),
  );
}

...
class UCCard extends StatelessWidget {
  ...
  const UCCard({Key? key, required this.ucAmount, required this.price}) : super(key: key);
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: IconButton(icon: const Icon(Icons.arrow_back_ios), onPressed: () => Get.back()),
                ),
              ],
            ),
            Padding(
              ...
              child: Wrap(
                ...
                children:
                    ucPackages.map((Map<String, String> ucPackage) {
                      return UCCard(ucAmount: ucPackage['ucAmount']!, price: ucPackage['price']!);
                    }).toList(),
              ),
            ),
          ],
